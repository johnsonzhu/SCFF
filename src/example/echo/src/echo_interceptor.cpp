...
namespace web_solution{ namespace web_framework{
    bool CEchoInterceptor::Init(void* pParameter)
    {
        m_sInterceptorName = "CEchoInterceptor";
        return true;
    }

    int CEchoInterceptor::InterceptBeforeProcess(void* pParameter)
    {
    ...
    int CEchoInterceptor::InterceptAfterProcess(void* pParameter)
    {
		return 0;
    }
